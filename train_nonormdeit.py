...
from nonormdeit import DieTClassifier


def main():
    parser = argparse.ArgumentParser(description="Train DeiT-3 Small with DyT (no LayerNorm) for Land Use Classification")
    ...
    parser.add_argument("--no_dyt",     action="store_true", help="Disable DyT (use standard LayerNorm)")
    parser.add_argument("--run_name",   default="deit3_dyt", help="Used to name the saved .pth file")
