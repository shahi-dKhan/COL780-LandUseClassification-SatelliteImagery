...
class SEBonus(ResNetSEClassifier):
    def __init__(
        self,
        img_dir,
        train_csv,
    ...
    def run_bonus(self, label_map_path, output_dir):
        ...
        print("Generating Grad-CAM visualizations for SE-ResNet bonus task...")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Bonus Task 3.1: Grad-CAM for SE-ResNet model")
    ...
    parser.add_argument(
        "--checkpoint",
        default="best_sne_model.pth",
        help="Path to trained Task 1.2 SE-ResNet checkpoint",
    )
    parser.add_argument(
        "--output_dir",
        default="bonus_outputs/sne_gradcam",
